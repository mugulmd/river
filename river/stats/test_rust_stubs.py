...
The Rust extension has no inline types, so `river/_river_rust/stats.pyi` is maintained by
hand. This test fails whenever a class, function, or method is added to (or removed from)
the Rust bindings without updating the stub, and vice versa.
"""
